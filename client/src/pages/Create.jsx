...
const Create = () => {
    ...
    return (
        ...
        <div className=' mx-[37px] min-h-[90vh] max-w-[1000px]  mt-[0.5em] '>
            ...
            <div className='bg-[#FFFFFF] rounded-[8px] pb-[30px] border-[#0000001f] border-[0.5px]'>
                ...
                <div className='px-[0.8em] flex'>
                    <div className='w-[50%] flex flex-col gap-[9px] mr-[10px]'>
                        <input type="text" className='text-[12px] placeholder:font-[700] pl-[7px] border-[1px] border-[#595959] h-[23px] rounded-[2px] ' placeholder='Disc Name *' />
                        <select className="w-full  text-[12px]  pl-[2px] border-[1px] border-[#595959]   rounded-[2px]  h-[23px]  ">
                        ...
                        <input
                            list="rangeOptions"
                            className="w-full text-[12px] bg-white border-[1px] border-[#595959] pl-[2px] rounded-[2px] h-[23px]"
                            placeholder="Range *"
                        />
                ...
                <div className='flex  items-start gap-[0px] px-[0.8em]'>
                    <div className='w-[50%] pr-[10px] mt-[15px] flex items-center '>
                        <input type="number" min={0} className='w-full text-[12px] placeholder:font-[700] pl-[2px] border-[1px] font-sans border-[#595959] h-[23px] rounded-[2px] ' placeholder={`Starting Price (${countryInfo.currency})`} />
                    </div>
                    <div className='w-[50%]  justify-start mt-[15px] flex flex-col items-start '>
                        <input type="number" min={0} className='w-full text-[12px] placeholder:font-[700] pl-[7px] border-[1px] font-sans border-[#595959] h-[23px] rounded-[2px] ' placeholder={`Min Price (${countryInfo.currency})`} />
                        <p className='font-[400] text-[.6rem] text-[#AAAAAA] text-left'>5 {countryInfo.currency} min price</p>
                    </div>
                </div>
                <div className='flex mx-[0.8em] mt-[10px]  '>
                    <div className='flex w-[60%] text-[12px] mr-[-10px] font-[500] bg-secondary'>
