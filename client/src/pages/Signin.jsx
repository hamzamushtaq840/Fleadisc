...
const Signin = () => {
    ...
    return (
        <div className='min-h-screen flex flex-col text-[1.1rem] sm:text-[1rem]  xsm:text-[1rem]' data-ux_mode="redirect">
            ...
            <div className='flex flex-1 sm:items-center md:items-center lg:items-center xl:items-center 2xl:items-center pb-[200px] flex-col mx-[46px] justify-center'>
                <h1 className='font-[700] max-w-[400px] font-sans leading-[39px] text-[2em]  w-full'>Sign in</h1>
            ...
            {/* <div className='flex  flex-col mx-[46px] justify-center '>
                <h1 className='font-[700] font-sans leading-[39px] text-[2em] self-start'>Create account</h1>
                <div className='mt-[27px]'>
                    <button onClick={() => register()} className='border rounded-[4px] bg-[#FFFFFF]  border-[#D9D9D9] p-[0.75em] w-full font-[500] text-[0.875em]  flex items-center'>
                        <img src={google} alt="" />
                        <h1 className='flex-1'>Sign up with Google</h1>
                    </button>
                    <p className='my-[11px] font-dmsans text-[8px] text-[#A5A5A5] flex justify-center'>OR</p>
                    <form className='flex flex-col gap-[7px]' onSubmit={handleRegistration}>
                        <input required type="email" className='p-[0.75em] bg-[#F5F5F5] font-sans font-[500] text-[0.875em] border rounded-[4px] border-[#D9D9D9]' placeholder='Email address' value={registrationState.email} name="email" onChange={handleRegistrationChange} />
                        <input required type="password" className='p-[0.75em] bg-[#F5F5F5] font-sans font-[500] text-[0.875em] border rounded-[4px] border-[#D9D9D9]' placeholder='Password' value={registrationState.password} name="password" onChange={handleRegistrationChange} />
                        <div className='flex justify-center'><button type="submit" className='w-[7.5em] h-[2.3125em] mt-[9px] text-[0.875em] font-[700] bg-primary text-[#ffff] shadow-2xl rounded-[6px]' style={{ boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 6px 4px -1px rgba(0, 0, 0, 0.06)" }}>Sign up</button></div>
                    </form>
                </div>
            </div > */}
