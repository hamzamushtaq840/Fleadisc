    ...
    return (
        <div className='min-h-screen flex flex-col' data-ux_mode="redirect">
            ...
            <div className='flex flex-1 sm:items-center md:items-center lg:items-center xl:items-center    2xl:items-center  pb-[200px] flex-col mx-[46px] justify-center '>
                <h1 className='font-[700] font-sans leading-[39px] text-[2rem]  w-full max-w-[600px] '>Create account</h1>
                <div className='mt-[27px] flex flex-col items-center  w-full'>
                    ...
                    <form className='flex flex-col gap-[7px] w-full items-center  ' onSubmit={handleRegistration}>
                        ...
                        <p className=' w-full max-w-[600px]  font-dmsans text-[12px] text-[#A5A5A5] flex justify-end hover:underline hover:text-[#000000] cursor-pointer' onClick={() => navigate('/signin')}>Already have an account ?</p>
