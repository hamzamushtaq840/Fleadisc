    ...
    return (
        <>
            <div className='flex flex-col items-center gap-[10px]'>
                <div className={`flex flex-col card  mb-[10px] pb-[8px] card rounded-[8px] bg-[#ffffff] xsm:min-w-[150px] sm:min-w-[150px] md:min-w-[200px] lg:min-w-[210px] xl:min-w-[220px] 2xl:min-w-[240px] xsm:max-w-[150px] sm:max-w-[150px] md:max-w-[200px] lg:max-w-[210px] xl:max-w-[220px] 2xl:max-w-[240px] `} >
                    <img src={value.discId.pictureURL} className=' w-full rounded-t-[8px]' alt="" />
