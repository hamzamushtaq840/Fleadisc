...
const Navbar = () => {
    ...
    return (
        <>
            <div className='flex h-[67px] justify-center fixed z-50 bg-[#FAFAFA] w-[100vw]'>
                <div className='h-[67px] bg-[#FAFAFA] w-full  fixed text-[1.2rem] sm:text-[0.75rem] xsm:text-[0.75rem]  font-sans font-[400] xsm:max-w-[100vw] sm:max-w-[100vw] max-w-[70vw] m-auto flex items-center justify-around gap-[1.256em] px-[1.125em]  '>
                    ...
                    <NavLink to="/delivery" className="nav-link flex flex-col gap-[3px] min-w-[50px] items-center  text-[#00000] " activeclassname="active">
                        ...
                        <h1 className='text-[0.75em]  mt-[-3px]'>Delivery</h1>
                    </NavLink>
                    <NavLink to="/create" className="nav-link flex flex-col pt-[1px] gap-[3px] min-w-[50px] items-center  text-[#00000] " activeclassname="active">
                        ...
                        <h1 className='text-[0.75em]  leading-[14.63px]'>Create</h1>
                    </NavLink>
