...
const Navbar = ({ children }) => {
    ...
    return (
        <>
            <div className='h-[67px] sm:text-[0.75rem] xsm:text-[0.75rem]  font-sans font-[400] xsm:max-w-[100vw] sm:max-w-[100vw] max-w-[70vw] m-auto flex items-center justify-around gap-[1.256em] px-[1.125em]  '>
